...
namespace LPRVFP
{
    [CustomEditor(typeof(LPRVFPPublisherReadme))]
    [InitializeOnLoad]
    public class PublisherReadmeEditor : Editor
    {
        ...
        [MenuItem("Window/Yel Scrypt Fire Studio/Low Poly Road Vehicles Free Package/Support And Docs")]
        private static LPRVFPPublisherReadme SelectReadme()
        {
            var ids = AssetDatabase.FindAssets("LPRVFPPublisherReadme t:LPRVFPPublisherReadme");
            ...
            if (ids.Length == 1)
            {
                ...
                return (LPRVFPPublisherReadme)readmeObject;
            }
            else
            {
        ...
        {
            var readme = (LPRVFPPublisherReadme)target;
