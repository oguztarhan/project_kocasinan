...
public static class Loc
{
    ...
    static readonly Dictionary<string, string[]> Table = new Dictionary<string, string[]>
    {
        ...
        { "GOLD PACKS", new[]{ "ALTIN PAKETLERİ","GOLD PACKS","GOLDPAKETE","PACCHETTI ORO","PAQUETES DE ORO","金币包","PACKS D'OR","PACOTES DE OURO","PAKET EMAS" } },
        { "SPECIAL OFFERS", new[]{ "ÖZEL TEKLİFLER","SPECIAL OFFERS","SONDERANGEBOTE","OFFERTE SPECIALI","OFERTAS ESPECIALES","特别优惠","OFFRES SPÉCIALES","OFERTAS ESPECIAIS","PENAWARAN KHUSUS" } },
        { "POWER-UPS", new[]{ "GÜÇLENDİRİCİLER","POWER-UPS","BOOSTER","POTENZIAMENTI","POTENCIADORES","强化道具","BONUS","POTENCIALIZADORES","PENGUAT" } },
        { "REMOVE ADS + BONUS", new[]{ "REKLAMSIZ + BONUS","REMOVE ADS + BONUS","WERBEFREI + BONUS","NIENTE PUBBLICITÀ + BONUS","SIN ANUNCIOS + BONUS","去广告 + 奖励","SANS PUB + BONUS","SEM ANÚNCIOS + BÔNUS","HAPUS IKLAN + BONUS" } },
        { "REMOVE BANNER", new[]{ "BANNERI KALDIR","REMOVE BANNER","BANNER ENTFERNEN","RIMUOVI BANNER","QUITAR BANNER","移除横幅","SUPPRIMER LA BANNIÈRE","REMOVER BANNER","HAPUS BANNER" } },
        { "HELICOPTER", new[]{ "HELİKOPTER","HELICOPTER","HUBSCHRAUBER","ELICOTTERO","HELICÓPTERO","直升机","HÉLICOPTÈRE","HELICÓPTERO","HELIKOPTER" } },
        ...
        { "Bonus round! Clear every vehicle before time runs out, and don't hit the cars crossing the road!", new[]{
            ...
            "Manche bonus ! Dégage tous les véhicules avant la fin du temps et ne percute pas les voitures qui traversent !","Rodada bónus! Limpa todos os veículos antes do tempo acabar e não batas nos carros que atravessam!","Ronde bonus! Bersihkan semua kendaraan sebelum waktu habis dan jangan tabrak mobil yang menyeberang!" } },
