...
namespace BusJam
{
    ...
    public partial class GameUI
    {
        ...
        void SectionLabel(Transform parent, string text, Sprite bgSprite = null, Color bgColor = default, float height = 74f, int fontSize = 40)
        {
        ...
        void CraftHeader(Transform parent)
        {
            ...
            AnchorLeft(Label(go.transform, "CRAFT", title, Vector2.zero, new Vector2(300, 58), fs, White, TextAnchor.MiddleLeft).rectTransform, 36, 0);
